...
//      this.pickerValueArrayChange = true;
            ...
            showPicker(n,o) {
                console.log(n,o,this.pickerValueArray)
                if(n) {
                    this.show()
                    this.pickerValueArrayChange = true;
                }
        ...
        methods: {
            ...
            parseVal(){
                ...
                selected.prov= this.pickerValueArray[this.pickerValue[0]].label
                selected.provVal= this.pickerValueArray[this.pickerValue[0]].value
                selected.city= this.pickerValueArray[this.pickerValue[0]].children[this.pickerValue[1]].label
                selected.cityVal= this.pickerValueArray[this.pickerValue[0]].children[this.pickerValue[1]].value
                selected.dist= this.pickerValueArray[this.pickerValue[0]].children[this.pickerValue[1]].children[this.pickerValue[2]].label
                selected.distVal= this.pickerValueArray[this.pickerValue[0]].children[this.pickerValue[1]].children[this.pickerValue[2]].value
            ...
            pickerConfirm(e) {
                ...
                this.$emit('onConfirm', this.parseVal());
            },
            showPickerView() {
                this.showPicker = true;
            },
            pickerChange(e) {
                ...
                this.$emit('onChange', this.parseVal());
            },
            pickerChangeMul(e) {
